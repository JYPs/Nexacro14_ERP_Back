...
import kr.co.seoulit.erp.hr.pm.applicationService.EmpApplicationService;
...
import kr.co.seoulit.erp.sys.dao.CompanyDAO;
import kr.co.seoulit.erp.sys.dao.CustomerDAO;
import kr.co.seoulit.erp.sys.dao.DepartmentDAO;
...
import kr.co.seoulit.erp.sys.dao.BaseYearDAO;
import kr.co.seoulit.erp.sys.dao.BusinessPlaceDAO;
...
public class BaseApplicationServiceImpl implements BaseApplicationService {
	...
	public String findSequenceNo(String findSeq) {
		...
		System.out.println("어플리케이션퍼사드에서 takeSeq에 담긴놈:"+takeSeq.get("findSeq"));
		System.out.println("어플리케이션퍼사드에 담긴놈 findSeq:"+findSeq);
