package kr.co.seoulit.erp.logi.purchase.serviceFacade;
...
import kr.co.seoulit.erp.logi.purchase.applicationService.BomApplicationService;
...
public class PurchaseServiceFacadeImpl implements PurchaseServiceFacade{
	...
	public List<OrderGatheringTO> findOrderGatheringList(String page) {
		// TODO Auto-generated method stub
		return orderApplicationService.findOrderGatheringList(page);
	}
	...
	public void registOrder(List<OrderInfoTO> orderInfoList, List<OrderDetailTO> orderDetailList,
		...
		// TODO Auto-generated method stub
		orderApplicationService.registOrder(orderInfoList,orderDetailList,orderGatheringList);
	}
