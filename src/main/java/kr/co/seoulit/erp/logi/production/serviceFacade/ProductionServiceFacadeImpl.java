package kr.co.seoulit.erp.logi.production.serviceFacade;
...
import kr.co.seoulit.erp.logi.production.applicationService.MpsApplicationService;
import kr.co.seoulit.erp.logi.production.applicationService.WorkInstructionApplicationService;
import kr.co.seoulit.erp.logi.production.applicationService.MrpApplicationService;
import kr.co.seoulit.erp.logi.production.applicationService.PrmApplicationService;
...
public class ProductionServiceFacadeImpl implements ProductionServiceFacade {
	...
	public List<MpsTO> findMpsList(HashMap<String, Object> searchDate) {
		...
		System.out.println("toDate :   "+ searchDate.get("toDate"));
		System.out.println("fromDate:   "+ searchDate.get("fromDate"));
	...
	public void registPrm(String empCode, List<PrmTO> prmList) {
		// TODO Auto-generated method stub
		prmApplicationService.registPrm(empCode, prmList);
	}
