package kr.co.seoulit.erp.logi.business.serviceFacade;
...
import kr.co.seoulit.erp.logi.business.applicationService.DeliveryApplicationService;
import kr.co.seoulit.erp.logi.business.applicationService.ContractApplicationService;
import kr.co.seoulit.erp.logi.business.applicationService.EstimateApplicationService;
import kr.co.seoulit.erp.logi.business.to.CompleteDeliveryResultTO;
...
import kr.co.seoulit.erp.logi.business.to.DeliveryResultTO;
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@contract@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	public List<ContractDetailTO> findRangedContractDetailList(HashMap<String, Object> searchDate) {
		// TODO Auto-generated method stub
		/*System.out.println(searchDate.get("value"));
		System.out.println(searchDate.get("requestStatus"));*/
